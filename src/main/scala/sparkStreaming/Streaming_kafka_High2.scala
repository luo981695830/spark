...
object Streaming_kafka_High2 {
  def main(args: Array[String]): Unit = {
    ...
    //偏移量保存在checkpoint中，可以从上次的位置接着消费
    ssc.checkpoint("chk_kafka_high2")
    ...
    val kafkaParams = Map(
      "zookeeper.connect"->"alyhadoop102:2181,alyhadoop103:2181,alyhadoop104:2181",
